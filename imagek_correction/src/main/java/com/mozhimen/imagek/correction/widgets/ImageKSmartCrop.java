package com.mozhimen.imagek.correction.widgets;
 ...
 */
public class ImageKSmartCrop extends androidx.appcompat.widget.AppCompatImageView {

    private static final String TAG = "ImageKSmartCrop";
    ...
    public ImageKSmartCrop(Context context) {
        this(context, null);
    }

    public ImageKSmartCrop(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageKSmartCrop(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        ScaleType scaleType = getScaleType();
        if (scaleType == ScaleType.FIT_END || scaleType == ScaleType.FIT_START || scaleType == ScaleType.MATRIX) {
            throw new RuntimeException("Image in ImageKSmartCrop must be in center");
        }
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ImageKSmartCrop);
        mMaskAlpha =
                Math.min(Math.max(0, typedArray.getInt(R.styleable.ImageKSmartCrop_imageKSmartCrop_MaskAlpha, DEFAULT_MASK_ALPHA)), 255);
        mShowGuideLine =
                typedArray.getBoolean(R.styleable.ImageKSmartCrop_imageKSmartCrop_ShowGuideLine, true);
        mLineColor =
                typedArray.getColor(R.styleable.ImageKSmartCrop_imageKSmartCrop_LineColor, DEFAULT_LINE_COLOR);
        mLineWidth =
                typedArray.getDimension(R.styleable.ImageKSmartCrop_imageKSmartCrop_LineWidth, dp2px(DEFAULT_LINE_WIDTH));
        mPointColor =
                typedArray.getColor(R.styleable.ImageKSmartCrop_imageKSmartCrop_PointColor, DEFAULT_LINE_COLOR);
        mPointWidth =
                typedArray.getDimension(R.styleable.ImageKSmartCrop_imageKSmartCrop_PointWidth, dp2px(DEFAULT_LINE_WIDTH));
        mMagnifierCrossColor =
                typedArray.getColor(R.styleable.ImageKSmartCrop_imageKSmartCrop_MagnifierCrossColor, DEFAULT_MAGNIFIER_CROSS_COLOR);
        mShowMagnifier =
                typedArray.getBoolean(R.styleable.ImageKSmartCrop_imageKSmartCrop_ShowMagnifier, true);
        mGuideLineWidth =
                typedArray.getDimension(R.styleable.ImageKSmartCrop_imageKSmartCrop_GuideLineWidth, dp2px(DEFAULT_GUIDE_LINE_WIDTH));
        mGuideLineColor =
                typedArray.getColor(R.styleable.ImageKSmartCrop_imageKSmartCrop_GuideLineColor, DEFAULT_GUIDE_LINE_COLOR);
        mPointFillColor =
                typedArray.getColor(R.styleable.ImageKSmartCrop_imageKSmartCrop_PointFillColor, DEFAULT_POINT_FILL_COLOR);
        mShowEdgeMidPoint =
                typedArray.getBoolean(R.styleable.ImageKSmartCrop_imageKSmartCrop_ShowEdgeMidPoint, true);
        mAutoScanEnable =
                typedArray.getBoolean(R.styleable.ImageKSmartCrop_imageKSmartCrop_AutoScanEnable, true);
        mPointFillAlpha =
                Math.min(Math.max(0, typedArray.getInt(R.styleable.ImageKSmartCrop_imageKSmartCrop_PointFillAlpha, DEFAULT_POINT_FILL_ALPHA)), 255);
        typedArray.recycle();
    }
    ...
    public void setImageToCrop(Bitmap bmp) {
        setImageBitmap(bmp);
        setCropPoints(mAutoScanEnable ? ImageKCorrection.getEdgePoints(bmp) : null);
    }
    ...
    public Bitmap crop(Point[] points) {
        ...
        return bmp == null ? null : ImageKCorrection.cropBitmapForEdgePoints(bmp, points);
    }
